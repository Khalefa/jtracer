// new jdiDebugger().onMehtodeExit("-cp <whatever your class path is>", "<name of the class that
// contains the main method>", "<the name of the class that you wish to debug>", "<the name of the
// method that you want to debug>")
